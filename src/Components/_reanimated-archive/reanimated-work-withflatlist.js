...
export default class Example extends React.Component {
      ...
      scrollToIndex = ([y]) => {
            this.flatListRef.scrollToOffset({ offset: y, animated: true });
      };
                        ...
                        <Animated.Code>
                              {() =>
                                    block([
                                          ...
                                          cond(
                                                // FIXME: and this.scrolling = 0, we want a different behavior for a scroll
                                                or(
                                          ...
                                          // cond(diff(this.dragY), call([this.dragY], this.scrollToIndex))
                                    ])
                              }
                        </Animated.Code>

                        <FlatList
                              // FIXME: Flatlist doesn't work because the PanHandler take the control, maybe use it also to scroll in the FlatList
                              ...
                              renderItem={item => {
                                    return (
                                          ...
                                          >
                                                ...
                                                >
                                                      <TouchableOpacity
                                                            onLongPress={() => this.handlerLongClick(item.index)}
